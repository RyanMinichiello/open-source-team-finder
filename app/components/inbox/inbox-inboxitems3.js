...
export default class InboxItems3 extends React.Component {
  render() {
    return (
      <div>
      <div className= "col-md-3">
        ...
        <div className= "inbox-zone">
          ...
          <InboxThread>
            <Inbox author="Lynda Doe" curr="message-current panel panel-default" read="read">
            </Inbox>
            ...
            <Inbox author="John Smith"  curr= "message-preview panel panel-default" read = "read">
            </Inbox>
